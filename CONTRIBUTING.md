So you're looking to contribute to Dify - we can't wait to see what you do! As a tiny startup with limited headcount and funding, we have grand ambitions to design the most intuitive and workflow for building and managing LLM applications. Any help from the community counts, truly.

We need to be nimble and ship fast given where we are, but we also want to make sure that contributors like you get as fun and smooth an experience at contributing as possible. We've assembled this contribution guide for that purpose, aiming at getting you familiarized with the codebase & how we work with contributors, so you could quickly jump to work. This guide, like Dify itself, is a constant work in progress and at times may lag behind the actual project. We highly appreciate your understanding if that happens.
...
* If you're opening a new feature request, we'd like you to explain what the proposed feature achieves, and include as much context as possible. Use this [feature request drafting bot](TODO) made by @pascal to save time fleshing out the issue.
...
* If you want to pick one up from the existing issues, simply drop a comment below it saying so.
  ...
  | @Joel                   | Making our frontend a breeze to use            |
  | @guchenhe & @crazywoola | Dev support and points of contact for anything |
...
After making your changes, open a pull request (PR) to. Once you submit your pull request, others from the Dify team/community will review it with you.
